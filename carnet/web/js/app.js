...
import {
  ...
  renderInfoMessages,
  setStatusMessage,
} from "./render.js?v=0019";
import { fetchCarnet } from "./api.js?v=0019";
import { buildValidationAccessUrl, clearValidationQrTimer, setupValidationQr } from "./qr.js?v=0019";
